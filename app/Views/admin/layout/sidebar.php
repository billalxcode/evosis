<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    <div class="app-brand demo">
        <a href="<?= base_url('/') ?>" class="app-brand-link">
            ...
            <span class="app-brand-text demo menu-text fw-bolder ms-2 text-uppercase">E-VoSis</span>
        </a>
    ...
    <ul class="menu-inner py-1">
        ...
        <li class="menu-item">
            ...
            <ul class="menu-sub">
                <li class="menu-item">
                    <a href="<?= base_url('admin/suara') ?>" class="menu-link">
        ...
        <li class="menu-item">
            ...
            <ul class="menu-sub">
                <li class="menu-item">
                    <a href="<?= base_url('admin/kandidat') ?>" class="menu-link">
                        <div data-i18n="Kelola Kandidat">Kelola Kandidat</div>
                    </a>
                </li>
                <li class="menu-item">
                    <a href="<?= base_url('admin/kandidat/create') ?>" class="menu-link">
