    ...
    <div class="row">
        <div class="col-xxl">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form action="<?= base_url('admin/siswa/save') ?>">
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <div class="input-group input-group-merge">
                                    ...
                                    <input type="text" class="form-control" id="name" placeholder="Masukan Nama Lengkap" aria-label="Nama Lengkap" aria-describedby="name-icon" />
                                </div>
                            </div>
                        </div>
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <div class="input-group input-group-merge">
                                    ...
                                    <!-- <input type="text" id="kelas" class="form-control" placeholder="Masukan Kelas" aria-label="Kelas" aria-describedby="kelas2" /> -->
                                    <select class="form-select" id="kelas" aria-label="Pilih kelas">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <div class="input-group input-group-merge">
                                    ...
                                    <select class="form-select" id="kelamin" aria-label="Pilih Kelamin">
