        ...
        <div class="authentication-inner">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <!-- /Logo -->
                    <h4 class="mb-2">Welcome to E-VoSis! 👋</h4>
                    <p class="mb-4">Silahkan masuk untuk mulai voting</p>
                    ...
                    <form id="formAuthentication" class="mb-3" action="<?= base_url('auth') ?>" method="POST">
                        ...
                        <?php endif ?>
                        <?php if (isset($errors)) echo var_dump($errors) ?>
                        <div class="mb-3">
                            <label for="nisn" class="form-label">Nomor Induk</label>
                            <input type="text" class="form-control" id="nisn" name="nisn" placeholder="Masukan Nomor Induk" autofocus />
                            <?php if (isset(session()->getFlashdata('errors')['nisn'])) : ?>
                                <div class="form-text text-danger"><?= session()->getFlashdata('errors')['nisn'] ?></div>
                            <?php endif ?>
                        </div>
